...
public static class GameObjectExtensions
{
	...
	/// <param name="g">the monobehhaviour to add or get the component</param>
	/// <typeparam name="T">The component wanted</typeparam>
	public static T GetOrAddComponent<T>(this MonoBehaviour m) where T : Component{
		return m.gameObject.GetOrAddComponent<T> ();
	}
